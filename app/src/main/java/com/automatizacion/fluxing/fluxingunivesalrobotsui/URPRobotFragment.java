...
public class URPRobotFragment extends Fragment {
    ...
    private AddRobotFragment.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_urp_robot, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof URPRobotFragment.OnFragmentInteractionListener) {
            mListener = (AddRobotFragment.OnFragmentInteractionListener) context;
        } else {
